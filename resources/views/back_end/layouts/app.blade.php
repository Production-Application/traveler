...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('back_end/assets/plugins/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('back_end/assets/plugins/jvectormap/jquery-jvectormap-2.0.3.min.css') }}"/>
    <link rel="stylesheet" href="{{ asset('back_end/assets/plugins/charts-c3/plugin.css') }}"/>

    <link rel="stylesheet" href="{{ asset('back_end/assets/plugins/morrisjs/morris.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('back_end/assets/plugins/jquery-datatable/dataTables.bootstrap4.min.css') }}">

    <!-- Multi Select Css -->
    <link rel="stylesheet" href="{{ asset('back_end/assets/plugins/multi-select/css/multi-select.css') }}">
    <!-- Bootstrap Spinner Css -->
    <link rel="stylesheet" href="{{ asset('back_end/assets/plugins/jquery-spinner/css/bootstrap-spinner.css') }}">
    <!-- Bootstrap Tagsinput Css -->
    <link rel="stylesheet" href="{{ asset('back_end/assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css') }}">
    <!-- Bootstrap Select Css -->
    <link rel="stylesheet" href="{{ asset('back_end/assets/plugins/bootstrap-select/css/bootstrap-select.css') }}" />
    <!-- noUISlider Css -->
    <link rel="stylesheet" href="{{ asset('back_end/assets/plugins/nouislider/nouislider.min.css') }}" />
    <!-- Select2 -->
...
<body class="theme-dark theme-green">

<!-- Page Loader -->
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img class="" src="{{ asset('back_end/assets/images/loader.svg') }}" width="48" height="48" alt="Aero"></div>
        <p>Please wait...</p>
    </div>
</div>
...
<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="{{ route('dashboard') }}"><img src="{{ asset('back_end/assets/images/logo.svg') }}" width="25" alt="Aero"><span class="m-l-10">Aero</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
...
<script src="{{ asset('back_end/assets/bundles/c3.bundle.js') }}"></script>

<!-- Jquery DataTable Plugin Js -->
<script src="{{ asset('back_end/assets/bundles/datatablescripts.bundle.js') }}"></script>
<script src="{{ asset('back_end/assets/plugins/jquery-datatable/buttons/dataTables.buttons.min.js') }}"></script>
<script src="{{ asset('back_end/assets/plugins/jquery-datatable/buttons/buttons.bootstrap4.min.js') }}"></script>
<script src="{{ asset('back_end/assets/plugins/jquery-datatable/buttons/buttons.colVis.min.js') }}"></script>
<script src="{{ asset('back_end/assets/plugins/jquery-datatable/buttons/buttons.flash.min.js') }}"></script>
<script src="{{ asset('back_end/assets/plugins/jquery-datatable/buttons/buttons.html5.min.js') }}"></script>
<script src="{{ asset('back_end/assets/plugins/jquery-datatable/buttons/buttons.print.min.js') }}"></script>

<script src="{{ asset('back_end/assets/plugins/jquery-inputmask/jquery.inputmask.bundle.js') }}"></script> <!-- Input Mask Plugin Js -->
<script src="{{ asset('back_end/assets/plugins/multi-select/js/jquery.multi-select.js') }}"></script> <!-- Multi Select Plugin Js -->
<script src="{{ asset('back_end/assets/plugins/jquery-spinner/js/jquery.spinner.js') }}"></script> <!-- Jquery Spinner Plugin Js -->
<script src="{{ asset('back_end/assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.js') }}"></script> <!-- Bootstrap Tags Input Plugin Js -->
<script src="{{ asset('back_end/assets/plugins/nouislider/nouislider.js') }}"></script> <!-- noUISlider Plugin Js -->
...
<script src="{{ asset('back_end/assets/js/pages/tables/jquery-datatable.js') }}"></script>
<script src="{{ asset('back_end/assets/js/pages/index.js') }}"></script>
</body>
